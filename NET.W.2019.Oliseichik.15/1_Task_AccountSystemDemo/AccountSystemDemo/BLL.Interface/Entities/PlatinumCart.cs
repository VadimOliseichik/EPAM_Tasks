...
namespace BLL.Interface.Entities
{
    ...
    public class PlatinumCart : Score
    {
        ...
        public PlatinumCart(string id, Client client, ScoreType scoreType, StatusScore status, decimal balance, int bonus)
            : base(id, client, scoreType, status, balance, bonus)
        {
